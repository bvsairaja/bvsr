...
if count > 0:
    ...
    print("No valid integers were entered, so no average can be calculated.")
...
my_string = "hello"
index = len(my_string) - 1  # Start at the index of the last character

while index >= 0:
    print(my_string[index])
    index -= 1  # Move to the previous character's index
